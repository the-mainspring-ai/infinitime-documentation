...
![](images_2/CH15_Sysmon2.gif)   Force Poll: Checks for punches
...
![](images_2/QSG_SETUP_IMP_SOURCEFILEOP.gif)
...
Field Name and click on the ![](images_2/i12.gif)
Button.
...
![](images_2/i26.gif) - Select this button to set the date picture. It will
...
![](images_2/UpdateIDF_PictureFormat.gif)

![](images_2/i25.gif) - The Override button brings up the Override option
...
![](images_2/Ch11_Export1.gif)

The Export Definition Table will be displayed
as shown below.

![](images_2/Ch11_Export2.gif)
...
![](images_2/FilterButton-Normal.gif) - The filter button allows you to specify
...
![](images_2/Ch11_Export6.gif)

![](images_2/Ch11_Export7.gif) - Adds information entered by the user to
...
![](images_2/Ch11_Export16.gif)

4.) The header will
be updated as shown.

![](images_2/Ch11_Export17.gif)
...
![](images_2/Ch11_Export19.gif)

![](images_2/Ch11_Export8.gif)
- Adds all Export Fields to the Target Grid.

![](images_2/Ch11_Export9.gif) - The order of the export file is defined
...
![](images_2/Ch11_Export13.gif) - The order of the export file is defined
by the fields in the target grid. The first field on Page 1 will be exported
as the first column of the export file. The second field will be in the
second column, while the third field will be in the third column, ect. This button will move the Selected Target Field
...
![](images_2/Ch11_Export10.gif) - The Override button opens the Export Override
...
![](images_2/Ch11_Export21.gif)

Click insert to insert
a new condition.

![](images_2/Ch11_Export22.gif)
...
![](images_2/Ch11_Export11.gif) - The Header Button provides the user with
...
![](images_2/Ch11_Export12.gif) - Restores
...
Refer to [InfiniTime Server SMTP Setup and Troubleshooting](/InfiniTime/RESOURCES/SMTP Email Setup And Troubleshooting.pdf)
for information on configuring and troubleshooting SMTP Service Settings
on the InfiniTime Server.

![](images_2/CH11Export_Email.gif)
...
![](images_2/AutoExportSchedUpdate.png)
...
5 - Groups](/InfiniTime/help%20file/Employee_Setup/Groups.md).
...
3 - Termination Reasons.](/InfiniTime/help%20file/HR_Information/Termination_Reasons.md)
...
* It should be
  ...
  Requirements](/InfiniTime/help%20file/INST_Ch2_SVR_Hardware_Req.md) and supported [Windows
  Operating Systems](/InfiniTime/help%20file/INST_Ch2_SVR_OSReq.md) for more information.
* The installation
...
* Added a copy button to the policy table. [(Chapter
  4 - Policy Table](/InfiniTime/help%20file/Policy/Policy_Table.md))
...
* A grand totals row has been added to the Timecard
  ...
  7: Timecard Activity)](/InfiniTime/help%20file/Time_Card_Activity_For_Company.md#Grand_Totals)
* Quick Assign has been updated with the following
  items: Shifts, Availabilitiy, Trained Tasks, Groups, and Default Schedule.
  [(Chapter
  2 - Quick Assign)](/InfiniTime/help%20file/Overview/Configuration/QuickAssign/Quick_Assign_Introduction.md)
...
* A message will now be sent to an employee's supervisor
  ...
  Types)](/InfiniTime/help%20file/Message_Types.md)
...
* Added an in depth troubleshooting section for Zephyr
  ...
  20 - Zephyr Troubleshooting)](/InfiniTime/help%20file/CH20_WANZEPHYRTS.md)
...
* Human Resource functionality within InfiniTime has been expanded to track
  ...
  5 - Employee Setup)](/InfiniTime/help%20file/Employee_Setup/Demographics.md)
...
* Quick Punch will no longer insert duplicate punches unless the
  ...
  checked. [(Chapter
  7 - Editing Timecard Activity)](/InfiniTime/help%20file/Edit_Time_Card_Activity.md#Duplicate_Punches)
...
* Warnings have been added to the Policy Table in order to deter
  ...
  4: Policy Update Form - General Information)](/InfiniTime/help%20file/Policy/General_Information.md#Configuring_Classes_And_Tenures)
* VCR Buttons have been added to the Schedule Gantt chart in order
  to simplify moving ahead or backward by one day. [(Chapter
  6 - Schedule Introduction)](/InfiniTime/help%20file/Schedule_Introduction.md)
...
* Added a From field to the Email Tab for
  ...
  Email)](/InfiniTime/help%20file/Email.md)
...
* + Apollo - [Bell
    Scheduling and Setup](/InfiniTime/help%20file/Overview/SoftwareAdministration/Reader_Config/Bell_Scheduling_and_Setup.md)
  + Apollo - [Access
    Control](/InfiniTime/help%20file/Overview/SoftwareAdministration/Reader_Config/Apollo_Access_Control.md)
  + Atlas - [Bell
    Scheduling and Setup](/InfiniTime/help%20file/Overview/SoftwareAdministration/Reader_Config/Bell_Scheduling_and_Setup_for_the_Atlas_Reader.md)
  + Atlas - [Access
    Control](/InfiniTime/help%20file/Overview/SoftwareAdministration/Reader_Config/Atlas_Access_Control.md)
  + Omega - [Bell
    Scheduling and Setup](/InfiniTime/help%20file/Overview/SoftwareAdministration/Reader_Config/Bell_Scheduling_and_Setup_for_the_Omega_Reader.md)
  + Omega - [Access
    Control](/InfiniTime/help%20file/Overview/SoftwareAdministration/Reader_Config/Omega_Access_Control.md)
  + Orion / Odyssey - [Bell
    Scheduling and Setup](/InfiniTime/help%20file/Overview/SoftwareAdministration/Reader_Config/Bell_Scheduling_and_Setup_for_the_Reader.md)
  + Orion / Odyssey - [Access
    Control](/InfiniTime/help%20file/Overview/Access_Control/Access_Control_for_the_Reader.md)
...
* A warning will now be displayed if the user
  ...
  4 - Missed Punch Threshold](/InfiniTime/help%20file/Policy/Overtime.md#Missing_Punch_Threshold) for more information on the Missed
...
* Additional Documentation has been added for the
  Luna Reader.
* + [Net
    Speed Configuration / Technical Note](/InfiniTime/help%20file/CH20_WanLunaTS.md#NetSpeed)
  + [New Communication
    Type: Poll From File](/InfiniTime/help%20file/CommTypes_Luna_PFF.md)
  + [Using and
    Configuring Poll From File with a Luna Reader](/InfiniTime/help%20file/Luna_PFF_Config.md)
  + [Updating the
    Bios Manually for the Luna Reader](/InfiniTime/help%20file/Luna_UpdateBFF.md)
* Additional Documentation has been added for the
  Zephyr Reader.
* + [Net
    Speed Configuration / Technical Note](/InfiniTime/help%20file/CH20_WANZEPHYRTS.md#NetSpeed)
  + [New Communication
    Type: Poll From File](/InfiniTime/help%20file/CommType_ZephyrPFF.md)
  + [Using
    and Configuring Poll From File with a Zephyr Reader](/InfiniTime/help%20file/ConfigurePollfromFileZephyr.md)
  + [Updating
    the Bios Manually for the Zephyr Reader](/InfiniTime/help%20file/Zephyr_UpdateBFF.md)
...
* Support for Telephone Punch has been added to the
  ...
  Punch Introduction.](/InfiniTime/help%20file/Telephone_Punch_Hardware_Introduction.md)
...
* Added support for Half Hour Rounding under the [Rounding
  Tab](/InfiniTime/help%20file/Policy/Unscheduled_Time.md) of the Policies.
* Added multiple fields for [Human
  Resource Related information](/InfiniTime/help%20file/Employee_Setup/HR_Profile.md).
...
* Support for sending bell schedules to the Zephyr, Luna, Juno, and
  ...
  Refer to [Bell Setup](/InfiniTime/help%20file/ZK_Bell_Schedules.md) for additional
  information.
...
* Corrected an error
  ...
  Clock Out Time' Setting](/InfiniTime/help%20file/Policy/Schedule_Settings_General_Tab.md#LatestClockOutTime) was incorrectly labeled "Latest Clock
  In Time"
* The Average Hours
...
* Added ['External
  Devices' Tab](/InfiniTime/help%20file/Reader_Settings_-_External_Devices.md) to the Reader Settings Section of the Reader Address
  Update form for the Thor Terminal. This tab includes settings for
  Wiegand Badge & Barcode Readers, and Relay Configuration.
* The [External
  Bell setting](/InfiniTime/help%20file/Thor_Fingerprint_-_Menu___Bios.md#Ext) on the Thor Terminal must be set to Yes in order
...
* [Total
  Hours Report](/InfiniTime/help%20file/Reader_Settings_-_Printer_Settings.md#TotalHoursReport) - Prints total Regular, OT1, OT2,
...
* [Accrual
  Totals Report](/InfiniTime/help%20file/Reader_Settings_-_Printer_Settings.md#Accrual Totals Report) - Prints Accrued Hours, Used
  Hours, and Remaining Hours for all Accrual Types assigned
  to a single employee.
* [In
  & Out Board Report](/InfiniTime/help%20file/Reader_Settings_-_Printer_Settings.md#In&Out) - Prints a list of all
  ...
  In.
* [Timecard
  Report](/InfiniTime/help%20file/Reader_Settings_-_Printer_Settings.md#TimecardReport) - Prints a report comparable to the
  ...
  and Other Activity.
* [Schedule
  Report](/InfiniTime/help%20file/Reader_Settings_-_Printer_Settings.md#ScheduleReports) - Prints schedule records for a single
  employee according to the 'Schedule' Date Range set for
  the Thor Terminal on the Reader Address Update Form.
* [Punch
  Receipt Report](/InfiniTime/help%20file/Reader_Settings_-_Printer_Settings.md#PunchReceipt) - Prints Employee Information
  ...
  table.
* [Messages
  Report](/InfiniTime/help%20file/Reader_Settings_-_Printer_Settings.md#MessageReports) - Prints messages from the Thor. Messages,
...
* The
  ...
  settings configured by the Reset Option are listed [here.](/InfiniTime/help%20file/Thor_Fingerprint_-_Menu___Bios.md#Reset)
* Resolved
...
* Resolved
  ...
  lockout can be found [here.](/InfiniTime/help%20file/Punching_In___Out_Using_Schedule_Lockout.md)
* Resolved
...
* [Holiday
  Options](/InfiniTime/help%20file/Dates_Tab.md) such as Holiday Starts Day Before, Holiday Ends on Holiday,
...
* [Support
  for Multiple Recipients](/InfiniTime/help%20file/Messaging_Introduction.md#MultipleRecipients) has been added for Time Off Requests and
...
* [Exceptions can now be assigned
  to policies.](/InfiniTime/help%20file/CH4_Policy_Exceptions.md) This makes it possible to set different exceptions
  for different groups of employees in addition to setting specific
  Exception Thresholds for different groups of employees.
* [Employee hours
  can now be automatically adjusted for Daylight Savings Time.](/InfiniTime/help%20file/Policy/Overtime.md#DaylightSavings) The
...
* The Form Security
  ...
  employees. More information can be found [here.](/InfiniTime/help%20file/Overview/SoftwareOverview/Modules/User_Interface/FormCompletion/CH2Configuring_Required_Fields.md)
* "Change
  ...
  in the distant future. An example of the warning can be reviewed [here.](/InfiniTime/help%20file/Messaging_Introduction.md#FutureDates)
* Overtime
  ...
  be found under the [Overtime Settings](/InfiniTime/help%20file/Overtime_Settings.md)
...
* Dollar
  ...
  Report showing Employee Accrual Dollar Amounts](/InfiniTime/help%20file/Reports/Employee_Information/employee_accruals.md) is provided for
  clarity.
* Total Accrued
...
* Additional options
  ...
  can be seen [here.](/InfiniTime/help%20file/Reports/Employee_Information/employee_accruals.md)
* 'Print
...
* The Group Category
  has been removed from the left side of the Employee Update Form. [Group Settings](/InfiniTime/help%20file/Employee_Setup/Groups.md) are now located
...
* [Premium Pay](/InfiniTime/help%20file/Pay_Premium_Introduction.md) has been added
...
* Activity
  ...
  Job Information File](/InfiniTime/help%20file/Overview/SoftwareAdministration/ImportExport/Target_Fields_Available_to_be_imported.md#JobImport)' as the file type.
* Activity
  Tasks can now be imported from a comma delimited file by using the
  Import Tool and selecting '[Activity
  Task Information File](/InfiniTime/help%20file/Overview/SoftwareAdministration/ImportExport/Target_Fields_Available_to_be_imported.md#Task Import)' as the file type.
* Shift
  Assignments can now be imported from a comma delimited file by using
  the Import Tool and selecting '[Employee
  Shifts File](/InfiniTime/help%20file/Overview/SoftwareAdministration/ImportExport/Target_Fields_Available_to_be_imported.md#Shifts)' as the file type.
* Automated
...
* [Edit Lockout can now be overridden
  by security role.](/InfiniTime/help%20file/Policy/Pay_Cycle.md#Lockout) This makes it possible to select security roles
...
* [Support for 'Split Punches
  at End of Day' has been added.](/InfiniTime/help%20file/Policy/Pay_Cycle.md#SplitPunches) This makes it possible to split
  ...
  same time.
* [Support for arbitrary pay cycles](/InfiniTime/help%20file/Policy/Pay_Cycle.md),
...
* Added
  ...
  Required to Work](/InfiniTime/help%20file/Dates_Tab.md#RequiredToWork)' option. This option makes it possible to require
...
* Added
  ...
  Based on Employee's Schedule](/InfiniTime/help%20file/Dates_Tab.md#ScheduleBased)' option. If this option is set to
...
![](images_2/3WAVG.jpg)            ![](images_2/21DHOLAVG.jpg)
...
+ [Days
  off](/InfiniTime/help%20file/CH5_Days_Off.md) can now be scheduled via the Scheduled Days Off Feature.
...
+ The Right Click Pop Up Menu in the
  ...
  Scheduled Days Off](/InfiniTime/help%20file/Editing_Exceptions_on_the_Time_Card_Activity.md#DayOff) and to [View
  All Scheduled Days Off](/InfiniTime/help%20file/Editing_Exceptions_on_the_Time_Card_Activity.md#ListDaysOff).
...
for performing the initial activation can be found [here.](/InfiniTime/help%20file/INSTCH8_Initial_Activation_Exising_Customer_with_HASP_Keys.md)
...
Licensing and Virtualization.](/InfiniTime/help%20file/INSTCH8_Software_Licensing_and_Virtualization.md)
...
feature can be found [here.](/InfiniTime/help%20file/CH7_InLineEditing.md) The
...
[The Client Installer Overview](/InfiniTime/help%20file/CH5_ClientInstall_Overview.md)

[Using the Client Installer: On-Site
Clients](/InfiniTime/help%20file/ClientInstall_Onsite.md)

[Using the Client Installer: Off-Site
Clients](/InfiniTime/help%20file/ClientInstall_OffSite.md)
...
* A warning will
  ...
  found [here.](/InfiniTime/help%20file/INSTCH8_Initial_Activation_Exising_Customer_with_HASP_Keys.md)
  For new customers with software license keys, instructions for activation
  can be found [here.](/InfiniTime/help%20file/INST_CH8_Initial_Software_Activation.md)
* Due to the
...
* [A
  New Option, Print Footer, has been added to the In And Out Board Report.](/InfiniTime/help%20file/Reports/Employee_Information/In___Out_Board.md#Footer)
...
* A
  ...
  Communication with Juno Readers](/InfiniTime/help%20file/Juno_Direct_Connection_(USB).md) and [USB
  communication with Zephyr Readers.](/InfiniTime/help%20file/CH23_HRDW_Zephyr_Direct_Connect_(USB).md)
* Microsoft
...
* A
  [client
  installer](/InfiniTime/help%20file/CH5_ClientInstall_Overview.md) which prepares a machine for remotely accessing the
  InfiniTime Application
...
For
more details, read about the [InfiniTime Software Licensing Solution.](/InfiniTime/help%20file/InfiniTime_Software_Licensing_-_Index.md)
...
System Alterations](/InfiniTime/help%20file/Overview/ovr_SoftwareAdministration.md#AccrualAlterations) section of this document.
...
![](images_2/RLSNOTE_707-06.jpg)

Accrual System Documentation

[Accrual
Introduction](/InfiniTime/help%20file/Overview/Configuration/Accrual_Configuration.md#acc41_Accrual_Plus_Module___Accrual_Calculation_Features___Settings_Introduction) (Accrual Periods, Carry Over, Reset Type, Effective Date,
General Setup Instructions)

[Accessing
Accrual Types](/InfiniTime/help%20file/Overview/Configuration/Accrual_Configuration.md#acc34_Accessing_the_Accrual_Types_Table)

[Accrual
Type Update Form](/InfiniTime/help%20file/Overview/Configuration/Accrual_Configuration.md#acc36_Accrual_Type_Update_Form_General_Tab:)

[Basic
Accruals](/InfiniTime/help%20file/Overview/Configuration/Accrual_Configuration.md#acc02_Employee_Accruals___Basic_Accruals_Overview)

[Accruals
Plus](/InfiniTime/help%20file/Overview/Configuration/Accrual_Configuration.md#acc26_Employee_Accruals_-_Accruals_Plus_Module_Overview)

[Using
Maximum Negative Accrual Hours](/InfiniTime/help%20file/Overview/Configuration/Accrual_Configuration.md#acc62_Maximum_Negative_Accrual)

[Using
Base Amounts](/InfiniTime/help%20file/Overview/ovr_SoftwareOverview.md#acc_BaseAmount)
...
+ InfiniTime
  ...
  [here](/InfiniTime/help%20file/CH7_ServerTS_TechInfoError.md).
...
[1. Obtain a TimeWolf 4 Backup](/InfiniTime/help%20file/INST_CH6_TW4toIT7_1.md)

[2. Verify Backup Integrity](/InfiniTime/help%20file/INST_CH6_TW4toIT7_2.md)

[3. Uninstall TimeWolf 4](/InfiniTime/help%20file/CH6_UPG_TW4toIT7_UninstTW.md)

[4. Install InfiniTime
7.0](/InfiniTime/help%20file/INST_CH6_TW4toIT7_3.md)

[5. Restore TimeWolf 4 Backup](/InfiniTime/help%20file/INST_CH6_TW4toIT7_4.md)

[6. Verify Imported Data](/InfiniTime/help%20file/INST_CH6_TW4toIT7_5.md)
...
* [Schedule
  Gannt Chart entries](/InfiniTime/help%20file/Overview/SoftwareAdministration/ImportExport/Target_Fields_Available_to_be_imported.md#EmployeeSchedulesFile) can now be imported from a comma delimited
...
[Timecard
Notes Overview](/InfiniTime/help%20file/SW_CH7_Notes_Overview.md)

[Inserting
Timecard Notes](/InfiniTime/help%20file/SW_CH7_Notes_Insert.md)

[Viewing
Timecard Notes](/InfiniTime/help%20file/SW_CH7_Notes_View.md)

[Timecard
Notes Report](/InfiniTime/help%20file/SW_CH7_Notes_Report.md)

* The [Attendance
  Review Report](/InfiniTime/help%20file/Reports/Schedule_Reports/attendance_review.md) now has the ability to display a Character for days
...
![](images_2/RemainingWindowInfinitime.jpg)
...
* [Additional functionality
  has been added to the 'Holiday Based on Employee's schedule' feature](/InfiniTime/help%20file/Dates_Tab.md#ScheduleBased).
...
* Resolved an issue which led to a script error when attempting to
  ...
  in length.
* The [Filter
  Button on the Export Update Form](/InfiniTime/help%20file/Overview/SoftwareAdministration/ImportExport/Export_Update_Form.md#ExportFilter) is now properly displayed only
...
* A [new
  string Registry Entry titled 'Hardware ID Only'](/InfiniTime/help%20file/InfiniTime_7.0_Registry_Keys.md#HARDWAREID) has been added
...
* The InfiniTime Accruals
  ...
  to Accrue To Stop At Amount After Time is Used'](/InfiniTime/help%20file/Accruals/accrual_calculations_update_form.md#ContinueToAccrue) is enabled, the
...
* Other Activity Types may now be counted among Hours Worked for
  ...
  as Hours Worked for Accrual Calculations'](/InfiniTime/help%20file/Company/Other_Activity_Types.md#OtherAct_CountTowardAccrual) option on the Other
...
* The method for calculating accrued hours via the 'Accrue X Hours
  ...
  examples are available.](/InfiniTime/help%20file/Accruals/AccrueByMonthExamples.md)
