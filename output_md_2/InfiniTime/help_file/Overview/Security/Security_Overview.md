...
![](images_2/secr4.gif) Copies the Highlighted Security Role.
...
![](images_2/secr5.gif) Opens the Security Role Update Form,
permitting the user to add a new security role.

![](images_2/ChangeButton-Normal.gif)Opens the Security Role Update Form for the selected
...
![](images_2/NightShiftSupervisor.png)
...
![](images_2/secr19.gif) Returns all security configuration settings
...
* Procedure
  ...
  using the Grid Security Key ( ![](images_2/Sec006.png) ) which is present
...
* Click on the Security Configuration Icon ![](images_2/secr1.gif).
...
roles. [Additional
details can be found below in the Default Values](/InfiniTime/help%20file/Overview/Security/Security_Overview.md#sec21_Default_Values)
...
![](images_2/SecFilter01.gif)

* Click on the Login Tab.

* Click on the Security Filter button.

![](images_2/SecFilter02.gif)
...
![](images_2/Ch2_ValidIP_UpdateForm.jpg)
...
![](images_2/ValidIP_OnsiteDept.jpg)
...
![](images_2/ValidIP_SpecComps.jpg)
...
![](images_2/EmpSpecValidIPSUBNET.jpg)
...
![](images_2/ValidIP_BlockedRemSites.jpg)
...
![](images_2/EmpSpecValidIP_BlockedRemSites.jpg)
...
![](images_2/EmpSpecValidIP_OnsiteOffsite.jpg)
...
![](images_2/CH2_PGP1.gif)

* The PGP tab will become available.

![](images_2/CH2_PGP2.gif)

* Refer to [PGP
  Encryption - Changing PGP](/InfiniTime/help%20file/Overview/Security/Security_Overview.md#sec66_PGP_Encryption_-_Changing_PGP_Key_Files) Key Files to configure the keys
  as appropriate for your PGP Client.

![](images_2/CH2_PGP3.gif)
...
* Refer to [PGP
  Encryption - Customizing PGP](/InfiniTime/help%20file/Overview/Security/Security_Overview.md#sec66_PGP_Encryption_-_Changing_PGP_Key_Files) to configure the keys as appropriate
  for your PGP Client.
...
for more information.](/InfiniTime/help%20file/RESOURCES/SMTP_Email_Setup_And_Troubleshooting.pdf)
...
![](images_2/CH2_PGP10.gif)

* The PGP tab will become available.

![](images_2/CH2_PGP11.gif)

* Refer to [PGP
  Encryption - Customizing PGP](/InfiniTime/help%20file/Overview/Security/Security_Overview.md#sec66_PGP_Encryption_-_Changing_PGP_Key_Files) to configure the keys as appropriate
  for your PGP Client.

![](images_2/CH2_PGP12.gif)
...
* Configure the Export as desired. Ensure the correct file type is
  ...
  Section of this document](/InfiniTime/help%20file/Overview/ovr_SoftwareAdministration.md#exp1_Export_Introduction) for more information.
...
![](images_2/CH2_PGP18.gif)

* Click Insert.

![](images_2/CH2_PGP19.gif)
...
![](images_2/CH2_PGP28.gif)

* Refer to [PGP
  Encryption - Customizing PGP Keys](/InfiniTime/help%20file/Overview/Security/Security_Overview.md#sec66_PGP_Encryption_-_Changing_PGP_Key_Files) to configure
...
Document](/InfiniTime/help%20file/RESOURCES/SMTP_Email_Setup_And_Troubleshooting.pdf) for more information.
...
in the [InfiniTime Escort Section](/InfiniTime/help%20file/Overview/Escort/Escort_Overview.md#esc01_Escort_Overview) of this
document.

![](images_2/PhunkeyTabOne1.png)
